...
public class StrategyPhotoContext {
    ...
    public Object savePhoto(String context, Integer id, InputStream photo, String title) throws FlickrException, IOException, ExecutionException, InterruptedException {
